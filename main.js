...
document.getElementById("ia-knowledge-btn").addEventListener("click", function() {
  const iaBox = document.getElementById("ia-knowledge-box");
  iaBox.classList.toggle("hidden");
  
  // Blocca lo scroll della pagina solo quando la finestra è aperta
  document.body.style.overflow = iaBox.classList.contains("hidden") ? "" : "hidden";
});
