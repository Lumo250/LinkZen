...
document.getElementById('toggle-menu-btn').addEventListener('click', () => {
  ...
  // Rimuovi sempre classi precedenti
  main.classList.remove('slide-in-left', 'slide-out-left', 'slide-in-right', 'slide-out-right', 'hidden');
  alt.classList.remove('slide-in-left', 'slide-out-left', 'slide-in-right', 'slide-out-right', 'hidden');

  if (!showingAlt) {
    // Mostra alt, nasconde main
    alt.classList.add('slide-in-left');
    main.classList.add('slide-out-left');
    setTimeout(() => {
      main.classList.add('hidden');
    }, 300);
  } else {
    // Mostra main, nasconde alt
    main.classList.add('slide-in-right');
    alt.classList.add('slide-out-right');
    setTimeout(() => {
