// ============================================
// AVVIO DARK MODE SE MEMORIZZATA
// ============================================
...
// ============================================
// TOOLTIP IA (piccolo badge visivo)
// ============================================
...
// ============================================
// APRI LINK IN SAFARI / NUOVA SCHEDA
// ============================================
...
// ============================================
// GESTIONE SUGGERIMENTI CATEGORIE
// ============================================
...
// ============================================
// RENDER CATEGORIE SELEZIONATE (CHIP VISIVI)
// ============================================
...
// ============================================
// GESTIONE POPUP DELLE CATEGORIE
// ============================================
...
// ============================================
// RENDER LISTA CATEGORIE NEL POPUP
// ============================================
...
// ============================================
// ELIMINAZIONE DI UNA CATEGORIA (CON AGGIORNAMENTO URL)
// ============================================
...
// ============================================
// EVENT LISTENER - Input categoria personalizzata
// ============================================
...
// ============================================
// EVENT LISTENER - Chiudi popup cliccando fuori
// ============================================
...
// ============================================
// EVENT LISTENER - Aggiungi categoria con Enter
// ============================================
...
// ============================================
// DOMContentLoaded - Inizializzazione completa
// ============================================
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // ============================================
  // GESTIONE CLICK FUORI EXPORT / IMPORT
  // ============================================
  ...
  // ============================================
  // IMPORT CUSTOM - File JSON selezionato
  // ============================================
  ...
  // ============================================
  // AUTOCOMPLETE e RENDER CATEGORIE all'avvio
  // ============================================

  const input = document.getElementById("new-category-input");

  // Aggiorna suggerimenti e chips
  updateCategorySuggestions();
  renderSelectedCategories();

  // Aggiunta categoria con Enter o Tab
  ...
  // ============================================
  // AGGIORNA CHIPS SE CAMBIA IL TEMA
  // ============================================

  document.getElementById("toggle-theme").addEventListener("change", () => {
    setTimeout(renderSelectedCategories, 300); // aspetta fine transizione
  });
  ...
  sortToggle.addEventListener("click", async () => {
    ...
    if (newSort !== "custom") {
      await loadUrls(); // Ricarica con nuovo ordinamento
    }
  });
...
// Gestisce il click sul bottone "save-btn" mostrando il menu di scelta e processando la selezione
// ==============================================
...
// Crea e mostra il dialog di selezione modalità salvataggio, gestisce le animazioni e la chiusura
// ==============================================
...
// Mostra istruzioni per usare il bookmarklet
...
// Mostra dialog per inserimento manuale link, con UI dark/light
async function showManualInputDialog() {
  return new Promise((resolve) => {
    ...
    // Effetti hover per pulsanti conferma e annulla
    ...
    // Funzione conferma dati inseriti
    const confirm = () => {
      const url = dialog.querySelector("#manual-url").value.trim();
      if (!url) {
        // Feedback visivo per campo URL obbligatorio
    ...
    // Conferma con tasto Enter su URL o titolo
    ...
    // Chiudi cliccando fuori dal dialogo
    dialog.addEventListener("click", (e) => {
      if (e.target === dialog) {
        dialog.style.opacity = "0";
        dialog.querySelector("div").style.transform = "translateY(20px)";
...
// Mostra un alert custom con titolo, messaggio e opzionale bottone copia
function showAlert(title, message, showCopyButton = false) {
  const alertDiv = document.createElement("div");
  const overlay = document.createElement("div");
  
  // Overlay semi-trasparente per sfondo
  ...
  // Gestione click su bottone chiusura
  closeButton.addEventListener("click", (e) => {
    e.stopPropagation();
    closeAlert();
  });

  // Chiudi cliccando sull'overlay (fuori alert)
  overlay.addEventListener("click", closeAlert);
  
  // Previeni chiusura cliccando sull'alert stesso
  ...
  // Ritorna funzione chiusura per controllo esterno
  return closeAlert;
}
...
// Funzione per salvare un link con categorizzazione
...
// Funzione per salvare il tab corrente (url + titolo)
...
// Caricamento iniziale (se presente un residuo di codice, da verificare)
// await loadUrls();  <-- attenzione a questa linea e parentesi chiuse che possono essere errate

// ============================================
// 6. FUNZIONE LOADURLS COMPLETA
// ============================================

// Funzione per caricare e mostrare gli URL salvati, gestire UI e categorie
async function loadUrls() {
  ...
  // Imposta la selezione ordinamento UI
  document.querySelectorAll('input[name="sort"]').forEach(radio => {
    radio.checked = (radio.value === sortOrder);
  });

  // Copia degli URL visitati e ordinamento per categoria se richiesto
  ...
  // Caricamento categorie di default da localStorage o fetch remoto
  try {
  ...
  // Combinazione delle categorie default con quelle personalizzate
  const allCategories = [...defaultCategories, ...userCategories];

  // Ciclo per costruire la lista degli URL con UI dinamica
  urls.forEach((item, index) => {
    ...
    // Evidenzia l'ultimo link aggiunto
    if (url === lastAddedUrl) {
    ...
    // Dropdown per la categoria con cambio dinamico
    ...
    // Link cliccabile con favicon e testo troncato
    const a = document.createElement("a");
    a.href = url;
    a.target = "_blank";
    ...
    // Gestione click link con tracking
    ...
    // Bottone per cancellare il link con undo
  ...
  // Scroll automatico all'ultimo link aggiunto
  if (lastAddedUrl) {
  ...
  // Animazione speciale per certe condizioni in dark mode
  if (
    sortOrder === "category" &&
  ...
  // Gestione stato e stile del pulsante Reset
  ...
  // Aggiornamento dropdown delle categorie personalizzate
  ...
  if (dropdown) {
    ...
    userCategories.forEach((cat) => {
      ...
      // Pulsante per rimuovere categoria utente
