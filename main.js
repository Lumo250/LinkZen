...
// Imposta lo stato iniziale a verde
...
// Resetta le classi e imposta lo stile
sortToggle.className = ""; // Rimuovi tutte le classi
if (sortOrder === "category") {
  sortToggle.classList.add("active"); // Verde
} else if (sortOrder === "custom") {
  sortToggle.classList.add("custom"); // Blu
} else {
  // Stile predefinito per "By Input" (blu chiaro)
  sortToggle.style.backgroundColor = "#e1f5fe";
  sortToggle.style.color = "#0277bd";
}
