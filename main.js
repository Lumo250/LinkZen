...
sortToggle.addEventListener("click", async () => {
  ...
  const newSort = currentSort.sortOrder === "default" ? "category" : "default";
  
  await storage.set({ sortOrder: newSort });
  sortToggle.textContent = newSort === "default" ? "By Input" : "By Category";
...
const sortToggle = document.getElementById("sort-toggle");
sortToggle.textContent = sortOrder === "default" ? "By Input" : "By Category";
sortOrder === "default" 
