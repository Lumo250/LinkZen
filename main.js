...
document.getElementById('toggle-menu-btn').addEventListener('click', () => {
  ...
  if (main.classList.contains('slide-in')) {
    ...
    alt.classList.remove('slide-out', 'hidden');
    alt.classList.add('slide-in');
  } else {
    alt.classList.remove('slide-in');
    alt.classList.add('slide-out');
    main.classList.remove('slide-out');
    main.classList.add('slide-in');
  }

  setTimeout(() => {
    if (main.classList.contains('slide-out')) main.classList.add('hidden');
    else main.classList.remove('hidden');

    if (alt.classList.contains('slide-out')) alt.classList.add('hidden');
    else alt.classList.remove('hidden');
  }, 400);
});
