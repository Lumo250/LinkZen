...
function applyFontSize(scale) {
  ...
  if (box) {
    ...
    // Applica la scala solo agli elementi specifici nella finestra delle categorie
    const categoriesBox = document.getElementById("categories-box");
    if (categoriesBox && !categoriesBox.classList.contains("hidden")) {
        const categoryItems = categoriesBox.querySelectorAll(".category-item");
