...
if (isStandalone) {
  ...
  goBtn.addEventListener("click", () => {
    ...
    // 👇 FUNZIONA SEMPRE: apertura diretta
    location.href = url;
  });
  ...
  saveBtn.addEventListener("click", () => {
    if (!lastManualUrl) return;
    // 👇 Aggiunta del link alla lista (deve esistere processNewLink nel tuo script)
    processNewLink(lastManualUrl, lastManualUrl);
  });
}
