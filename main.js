...
// ==============================================
// GESTIONE BARRA NAVIGAZIONE STANDALONE
// ==============================================
function setupStandaloneNavigation() {
  ...
  // Apertura URL nella stessa finestra
  goBtn.addEventListener("click", () => {
    ...
    try {
      ...
      // Apri nella stessa finestra (non _blank)
...
// Controlla ad ogni caricamento di pagina
window.addEventListener('load', setupStandaloneNavigation);
